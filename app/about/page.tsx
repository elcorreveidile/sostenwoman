export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <h1 className="text-4xl font-bold text-stone-900 mb-8">Conócenos</h1>
      ...
      <section className="prose prose-stone max-w-none">
        ...
        <h2 className="text-2xl font-semibold text-stone-900 mt-12 mb-4">Nuestra Misión</h2>
        ...
        <h2 className="text-2xl font-semibold text-stone-900 mt-12 mb-4">Lo que nos define</h2>
        ...
        <h2 className="text-2xl font-semibold text-stone-900 mt-12 mb-4">Nuestro compromiso</h2>
        <p className="text-stone-600 mb-6">
